            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <table class="table table-bordered" id="sortTable">
                        <thead class="">
                            <tr><td>id</td><td width="35%">Название программы</td><td width="10%">Часов по плану</td><td width="10%">Часов по факту</td><td>Дисциплины</td><td>Активна?</td><td>Операции</td></tr>
                        </thead>
                        <tbody>
