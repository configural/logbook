                    ...
                    @if(Auth::user()->role_id == 4)  
                      <form action="store" method="post">
                          ...
                          <p><label>Фамилия</label>
                              <input type="text" value="{{ $student->secname }}" class="form-control" name="name"></p>
                          
                          <p><label>Имя</label>
                              <input type="text" value="{{ $student->name }}" class="form-control" name="name"></p>
                          
                          <p><label>Отчество</label>
                              <input type="text" value="{{ $student->fathername }}" class="form-control" name="name"></p>
                          
                          <p><label>Код СОНО</label>
                              <input type="text" value="{{ $student->sono }}" class="form-control" name="name"></p>
