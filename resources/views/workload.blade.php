                ...
                <div class="panel-heading ">
                    ...
                    <div class="panel-body">
                        ...
                        <p>Вы методист и вам нужно распределить нагрузку по преподавателям. 
                            ...
                            Если нужной нагрузки в таблице нет, создайте ее вручную. Если нагрузка сформирована не полностью, нажмите кнопку "Создать недостающую нагрузку"</p>
                        <p><a href='workload/add' class='btn btn-success'>Создать элемент нагрузки вручную</a> 
                         <a href='workload/rebuild?stream_id={{$stream_id}}' class='btn btn-danger'>Создать недостающую нагрузку</a></p>
